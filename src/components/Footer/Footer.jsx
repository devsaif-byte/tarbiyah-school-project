...
export function FooterWithLogo() {
	return (
		<footer className="mt-16 bg-mintGreen sticky top-full">
			<svg
				className="absolute top-0 w-full h-6 -mt-5 sm:-mt-10 sm:h-16 text-mintGreen"
			...
			<div className="px-4 pt-12 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
				<div className="grid gap-16 row-gap-10 mb-8 lg:grid-cols-6">
					<div className="md:max-w-md lg:col-span-2">
						...
						>
							<Image src={logo} width={60} height={60} radius="full" />
				...
				<div className="flex flex-col justify-between pt-5 pb-10 border-t border-deep-purple-accent-200 sm:flex-row">
					<p className="text-sm text-gray-100">
						© Copyright Tarbiyah Ideal School 2023-{new Date().getFullYear()}. |
						All rights reserved.
					</p>
					<p className="text-sm text-gray-100">
						Developed by |
						<Link to="https://www.linkedin.com/in/md-saif-bd/">
							{" "}
							Mohammad Saif
						</Link>
					</p>
